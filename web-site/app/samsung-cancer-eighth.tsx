...
function DoubleRoomPlan(){
 return <figure className="double-room-plan"><svg viewBox="0 0 520 620" role="img" aria-labelledby="double-plan-title double-plan-description">
  <title id="double-plan-title">808호 2인실 평면배치도</title><desc id="double-plan-description">아래 복도에서 왼쪽 출입구로 들어갑니다. 오른쪽 입구 옆은 화장실이며 화장실은 출입문 쪽으로 넓혔습니다. 환자 침대 두 개는 750×2100mm 비율이며 머리를 오른쪽 벽에 두고 커튼 양쪽에 가깝게 배치했습니다. 창가 간병인 침대는 창문 벽에 붙였습니다. 각 환자 침대 바깥쪽인 창가와 화장실 쪽에 600×1800mm 간병인 침대를 하나씩 점선과 바퀴로 표시했습니다. 창문은 출입구 반대편 위쪽입니다.</desc>
  ...
  <g fill="#e8f3f0" stroke="#467b72" strokeWidth="3"><rect x="260" y="141" width="228" height="81.43" rx="10"/><rect x="260" y="234" width="228" height="81.43" rx="10"/></g>
  ...
  <g fontSize="13" textAnchor="middle" fill="#467b72"><text x="350" y="198">750 × 2100 mm</text><text x="350" y="291">750 × 2100 mm</text></g>
 ...
 </svg><figcaption>환자 침대는 750×2100mm(75×210cm) 비율로 커튼 양쪽에 배치하고, 창가 간병인 침대는 창문 벽에 붙였습니다. 점선과 바퀴는 이동식 간병인 침대(600×1800mm, 가로세로 3:1 비율)를 나타냅니다. 전체 도면은 실측 축척이 아닌 개념도입니다. 808호의 실측 치수와 문 열림 방향은 현장 확인 후 확정합니다.</figcaption></figure>;
}
