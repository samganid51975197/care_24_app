...
function DoubleRoomPlan(){
 return <figure className="double-room-plan"><svg viewBox="0 0 520 620" role="img" aria-labelledby="double-plan-title double-plan-description">
  <title id="double-plan-title">808호 2인실 평면배치도</title><desc id="double-plan-description">아래 복도에서 왼쪽 출입구로 들어갑니다. 오른쪽 입구 옆은 화장실이며 그 뒤로 침대 두 개가 창문 방향으로 놓이고 사이에 커튼이 있습니다. 창문은 출입구 반대편 위쪽입니다.</desc>
  ...
  <g fill="#e8f3f0" stroke="#467b72" strokeWidth="3"><rect x="295" y="75" width="145" height="125" rx="10"/><rect x="295" y="255" width="145" height="125" rx="10"/></g>
  <g fill="#fff" stroke="#467b72" strokeWidth="2"><rect x="312" y="88" width="110" height="25" rx="5"/><rect x="312" y="268" width="110" height="25" rx="5"/></g>
  <text x="367" y="155" textAnchor="middle">침대 · 창가 쪽</text><text x="367" y="335" textAnchor="middle">침대 · 화장실 뒤</text>
  <path d="M235 225H465" stroke="#a56795" strokeWidth="4" strokeDasharray="9 6"/><text x="170" y="232" fill="#854575">커튼</text>
  <rect x="285" y="415" width="205" height="130" fill="#eef1f6" stroke="#365d62" strokeWidth="3"/><text x="385" y="474" textAnchor="middle">화장실</text><text x="385" y="502" textAnchor="middle">입구 오른쪽</text>
 ...
 </svg><figcaption>말씀하신 일반적인 2인실 구조를 반영한 개념도입니다. 808호의 실측 치수와 문 열림 방향은 현장 확인 후 확정합니다.</figcaption></figure>;
}
