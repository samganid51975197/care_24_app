...
function DoubleRoomPlan(){
 return <figure className="double-room-plan"><svg viewBox="0 0 520 620" role="img" aria-labelledby="double-plan-title double-plan-description">
  ...
  <path d="M240 35V400" fill="none" stroke="#a56795" strokeWidth="4" strokeDasharray="9 6"/><text transform="translate(330 0) scale(-1 1)" x="165" y="155" textAnchor="middle" fill="#854575" fontSize="14">발치 전체 커튼</text>
