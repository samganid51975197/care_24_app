...
function DoubleRoomPlan(){
 return <figure className="double-room-plan"><svg viewBox="0 0 520 620" role="img" aria-labelledby="double-plan-title double-plan-description">
  <title id="double-plan-title">808호 2인실 평면배치도</title><desc id="double-plan-description">아래 복도에서 왼쪽 출입구로 들어갑니다. 오른쪽 입구 옆은 화장실이며 화장실은 출입문 쪽으로 넓혔습니다. 환자 침대 두 개는 머리를 오른쪽 벽에 두고 커튼 양쪽에 가깝게 배치했습니다. 각 환자 침대 바깥쪽인 창가와 화장실 쪽에 600×1800mm 간병인 침대를 하나씩 점선과 바퀴로 표시했습니다. 창문은 출입구 반대편 위쪽입니다.</desc>
  ...
  <g fill="#e8f3f0" stroke="#467b72" strokeWidth="3"><rect x="260" y="125" width="228" height="95" rx="10"/><rect x="260" y="235" width="228" height="95" rx="10"/></g>
  <g fill="#fff" stroke="#467b72" strokeWidth="2"><rect x="451" y="137" width="26" height="71" rx="5"/><rect x="451" y="247" width="26" height="71" rx="5"/></g>
  <text x="350" y="180" textAnchor="middle">환자 침대</text><text x="350" y="290" textAnchor="middle">환자 침대</text>
  <g aria-label="간병인 이동식 침대 두 개 · 각각 600×1800mm" fill="#fff8e9" stroke="#977337" strokeWidth="2" strokeDasharray="6 4">
   <rect x="308" y="59" width="180" height="60" rx="5"/><rect x="308" y="337" width="180" height="60" rx="5"/>
  </g>
  <g fill="#fff" stroke="#977337" strokeWidth="2">{[59,337].map(y=><g key={y}><rect x="465" y={y+12} width="16" height="36" rx="3"/>{[317,479].map(x=><g key={x}><circle cx={x} cy={y+5} r="3"/><circle cx={x} cy={y+55} r="3"/></g>)}</g>)}</g>
  <g fontSize="13" fill="#785921" textAnchor="middle"><text x="386" y="82">간병인 침대 · 창가</text><text x="386" y="103">600 × 1800 mm</text><text x="386" y="360">간병인 침대 · 화장실 쪽</text><text x="386" y="381">600 × 1800 mm</text></g>
 ...
 </svg><figcaption>환자 침대는 커튼 양쪽에, 간병인 침대는 창가·화장실 쪽에 배치했습니다. 점선과 바퀴는 이동식 간병인 침대(600×1800mm, 가로세로 3:1 비율)를 나타냅니다. 전체 도면은 실측 축척이 아닌 개념도입니다. 808호의 실측 치수와 문 열림 방향은 현장 확인 후 확정합니다.</figcaption></figure>;
}
