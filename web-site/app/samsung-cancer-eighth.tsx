...
function DoubleRoomPlan(){
 return <figure className="double-room-plan"><svg viewBox="0 0 520 620" role="img" aria-labelledby="double-plan-title double-plan-description">
  <title id="double-plan-title">808호 2인실 평면배치도</title><desc id="double-plan-description">아래 복도에서 왼쪽 출입구로 들어갑니다. 오른쪽 입구 옆은 화장실이며 화장실은 출입문 쪽으로 넓혔습니다. 그 뒤로 침대 두 개가 머리 쪽을 오른쪽 벽에 붙인 가로 방향으로 놓이고 사이에 커튼이 있습니다. 창문은 출입구 반대편 위쪽입니다.</desc>
  ...
  <g fill="#e8f3f0" stroke="#467b72" strokeWidth="3"><rect x="260" y="80" width="228" height="105" rx="10"/><rect x="260" y="270" width="228" height="105" rx="10"/></g>
  <g fill="#fff" stroke="#467b72" strokeWidth="2"><rect x="451" y="97" width="26" height="71" rx="5"/><rect x="451" y="287" width="26" height="71" rx="5"/></g>
  <text x="350" y="139" textAnchor="middle">침대 · 창가 쪽</text><text x="350" y="329" textAnchor="middle">침대 · 화장실 뒤</text>
 ...
 </svg><figcaption>화장실은 출입문 쪽으로 넓히고, 침대는 머리를 오른쪽 벽에 붙여 길쭉한 비율로 표시한 개념도입니다. 808호의 실측 치수와 문 열림 방향은 현장 확인 후 확정합니다.</figcaption></figure>;
}
