...
function DoubleRoomPlan(){
 return <figure className="double-room-plan"><svg viewBox="0 0 520 620" role="img" aria-labelledby="double-plan-title double-plan-description">
  ...
  <path d="M240 35V400H270" fill="none" stroke="#a56795" strokeWidth="4" strokeDasharray="9 6"/>
  ...
  <rect x="270" y="400" width="220" height="116" fill="#eef1f6" stroke="#365d62" strokeWidth="3"/><text transform="translate(760 0) scale(-1 1)" x="380" y="447" textAnchor="middle">화장실</text><text transform="translate(760 0) scale(-1 1)" x="380" y="475" textAnchor="middle">입구 왼쪽</text>
